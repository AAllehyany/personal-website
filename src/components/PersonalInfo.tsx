...
const PersonalInfo = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex items-center justify-center w-full border-b border-gray-400 p-3">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"  className="fill-current text-yellow-600 w-8 h-8 mr-3">
